      ...
      <div className="fixed top-2 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-6xl">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div className="h-5 w-24 rounded bg-primary/15 hidden sm:block" />
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-9 h-9 rounded-full bg-primary/10" />
            <div className="hidden sm:block h-10 w-28 rounded-full bg-primary/25 border border-primary/20" />
          </div>
        </motion.div>
      </div>
              ...
              >
                ...
                <div className="space-y-2">
                  {Array.from({ length: 4 }).map((_, j) => (
                    <div
                      key={j}
                      className="h-4 w-full rounded bg-primary/10"
                    />
                  ))}
                </div>
              </motion.div>

        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          >
            <section className="mb-10 p-6 rounded-2xl bg-card/50 border border-border/50">
              ...
              <p className="text-muted-foreground">These Terms of Service govern your use of our website and services. By using our services, you agree to these terms.</p>
            </section>

            <section className="mb-10 p-6 rounded-2xl bg-card/50 border border-border/50">
              <h2 className="text-2xl font-bold text-primary mb-4">2. Use of Services</h2>
              <p className="text-muted-foreground">You represent that you are at least 18 years old and are legally capable of entering into a binding contract.</p>
            </section>
